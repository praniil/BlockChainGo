...
func verifySignature(user string, msg string) {
...
func (b *BlockChain) addBlock(from, to string, amount float64, msg string) {
...
func main() {
	...
	blockchain.addBlock("Alice", "Bob", 5, "hello world")
